...
#	MR , im here where you baby
#	contact  owner bot fb :)
#	its for you enjoy from it
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Af2' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
